...
const AdminOrders = () => {
  ...
  const getOrders = async () => {
    try {
      const response = await fetch("https://food-5mu1.onrender.com/api/v1/auth/all-orders", {
        method: "GET",
        headers: {
  ...
  const handleChange = async (orderId, value) => {
    try {
      const response = await fetch(`https://food-5mu1.onrender.com/api/v1/auth/status/${orderId}`, {
        method: "PUT",
        headers: {
          Authorization: AuthorizationToken,
