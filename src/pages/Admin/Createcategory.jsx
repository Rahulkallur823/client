...
const CreateCategory = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://food-5mu1.onrender.com/api/v1/category/create-category', {
        method: "POST",
        headers: {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://food-5mu1.onrender.com/api/v1/category/update-category/${selected._id}`, {
        method: "PUT",
        headers: {
          Authorization: AuthorizationToken,
        },
  ...
  const handleDelete = async (id) => {
    try {
      const response = await fetch(`https://food-5mu1.onrender.com/api/v1/category/delete-category/${id}`, {
        method: "DELETE",
        headers: {
          'Content-Type': 'application/json',
          Authorization: AuthorizationToken,
                    ...
                    <tbody>
                      {categories.map((category) => (
                        <tr key={category._id}>
                          ...
                          <td>
                            <img
                              src={`https://food-5mu1.onrender.com/api/v1/category/category-image/${category._id}`}
                              alt="Category"
                          ...
                          <td>
                            <StyledButton
                              ...
                              onClick={() => {
                                ...
                                setUpdateImagePreview(`https://food-5mu1.onrender.com/api/v1/category/category-image/${category._id}`);
                                setShowModal(true);
                              }}
                            >
                              <Edit />
