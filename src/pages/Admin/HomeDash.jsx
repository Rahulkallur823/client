...
const HomeDash = () => {
  ...
  useEffect(() => {
    fetch('https://food-5mu1.onrender.com/api/v1/auth/counter')
  ...
  return (
    <div style={{ padding: '20px', backgroundColor: '#F3F4F6' }}>
      ...
      <div style={{ 
        ...
        <Card title="Total Products" value={dashboardData.totalProducts} icon={<FaBoxes />} color="#F59E0B" increase="+3%" />
