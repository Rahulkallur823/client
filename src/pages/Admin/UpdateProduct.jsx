...
const UpdateProduct = () => {
  ...
  const getSingleProduct = async () => {
    try {
      const response = await fetch(`https://food-5mu1.onrender.com/api/v1/product/get-product/${params.slug}`);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://food-5mu1.onrender.com/api/v1/product/update-product/${id}`, {
        method: "PUT",
        headers: {
  ...
  const handleDelete = async () => {
    try {
      ...
      const response = await fetch(`https://food-5mu1.onrender.com/api/v1/product/delete-product/${id}`, {
        method: "DELETE",
        headers: {
          Authorization: AuthorizationToken,
        },
