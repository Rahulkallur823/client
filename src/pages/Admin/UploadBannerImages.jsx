...
const UploadBannerImages = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await fetch('https://food-5mu1.onrender.com/api/v1/product/uploadc', {
        method: 'POST',
        headers: {
          Authorization: AuthorizationToken,
        },
      ...
      if (response.ok) {
        ...
        const updatedImagesResponse = await fetch('https://food-5mu1.onrender.com/api/v1/product/carousel-images', {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
            Authorization: AuthorizationToken,
