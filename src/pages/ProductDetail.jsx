...
const ProductDetails = () => {
  ...
  const getsimilarproduct = async (pid, cid) => {
    try {
      const response = await fetch(`https://food-5mu1.onrender.com/api/v1/product/similar-product/${pid}/${cid}`);
      const data = await response.json();
      if (data.success) {
          ...
          <div className="product-info-container">
            ...
            <div className="product-meta">
              ...
              <div className="product-meta-item">
                ...
                <span className={`product-meta-value ${product.inStock ? 'text-danger' : 'text-success'}`}>
