...
export const AuthProvider = ({ children }) => {
  ...
  const userAuthentication = async () => {
    ...
    try {
      const response = await fetch("https://food-5mu1.onrender.com/api/v1/auth/user-info", {
        method: "GET",
        headers: {
  ...
  const getAllUsersData = async () => {
    ...
    try {
      const response = await fetch('https://food-5mu1.onrender.com/api/v1/admin/users', {
        method: "GET",
        headers: {
          Authorization: AuthorizationToken,
